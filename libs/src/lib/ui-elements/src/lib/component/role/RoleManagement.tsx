          ...
          <div className="col-4">
            ...
            <select
              ...
              >
                ...
                <option value="0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6">Mint</option>
                <option value="0x3c11d16cbaffd01df69ce1c404f6340ee057498f5f00246190ea54220576a848">Burn</option>
                <option value="0x65d7a28e3265b37a6474929f336521b332c1681b933f6cb9f3376673440d862a">Pause</option>                  
              </select>
              {selectedCoinAddressTypeErr != "" && <p className="error-msg">{selectedCoinAddressTypeErr}</p> }
            </div>
            <div className={styles['cashBox']} >
            <label>Wallet Address</label>
            <input type="text" name="cash" value={address} onChange={(e) => setAddress(e.target.value)} />
